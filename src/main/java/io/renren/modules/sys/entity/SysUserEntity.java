...
public class SysUserEntity implements Serializable {
	 ...
	 * 用户ID
	 */
	@ApiModelProperty(value="用户ID",required=false,example="",hidden=true)
	private Long userId;
	 ...
	 * 盐
	 */
	@ApiModelProperty(value="盐",required=false,example="")
	private String salt;
	 ...
	 * 状态  0：禁用   1：正常
	 */
	@ApiModelProperty(value="状态  0：禁用   1：正常",required=false,example="")
	private Integer status;
	
	/**
	 * 角色ID列表
	 */
	@ApiModelProperty(value="角色ID列表",required=false,example="")
