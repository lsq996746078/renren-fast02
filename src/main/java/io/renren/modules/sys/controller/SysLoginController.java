 ...
 */
@RestController
@Api(value="登录相关",description="SysLogin")
public class SysLoginController extends AbstractController {
	...
	@ApiOperation(httpMethod = "GET", value = "验证码", produces = MediaType.APPLICATION_OCTET_STREAM_VALUE)
	@ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = false)
	})
	...
	@ApiOperation(httpMethod = "POST", value = "登录",response=SysUserEntity.class)
	@ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = false),
