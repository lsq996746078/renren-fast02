...
public class ScheduleJobController {
	...
	@ApiOperation(httpMethod = "GET", value = "定时任务列表",responseContainer="map")
    @ApiImplicitParams(value = {
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = true),
		@ApiImplicitParam(paramType = "query", dataType = "String", name = "params", value = "params", required = true),
		...
		@ApiImplicitParam(paramType = "query", dataType = "String", name = "beanName", value = "spring bean名称", required = false)
	})
	...
	@ApiOperation(httpMethod = "GET", value = "定时任务信息" )
    @ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = true),
		@ApiImplicitParam(paramType = "query", dataType = "Long", name = "jobId", value = "jobId", required = true)
	})
	...
	@ApiOperation(httpMethod = "POST", value = "保存定时任务")
    @ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = true)
	})
	...
	@ApiOperation(httpMethod = "POST", value = "修改定时任务" )
    @ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = true)
	})
    ...
    @ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = true),
		@ApiImplicitParam(paramType = "query", dataType = "Long", name = "jobIds", value = "jobIds", required = true)
	})
	...
	@ApiOperation(httpMethod = "POST", value = "立即执行任务" )
    @ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = true),
		@ApiImplicitParam(paramType = "query", dataType = "Long", name = "jobIds", value = "jobIds", required = true)
	})
	...
	@ApiOperation(httpMethod = "POST", value = "恢复定时任务" )
    @ApiImplicitParams({
		@ApiImplicitParam(paramType = "header", dataType = "String", name = "token", value = "token", required = true),
		@ApiImplicitParam(paramType = "query", dataType = "Long", name = "jobIds", value = "jobIds", required = true)
	})
